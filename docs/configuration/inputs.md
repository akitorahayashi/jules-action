...
| `require-plan-approval` | no | none | Optional boolean string (`true` or `false`) |
| `automation-mode` | no | none | Optional enum (`AUTOMATION_MODE_UNSPECIFIED` or `AUTO_CREATE_PR`) |
